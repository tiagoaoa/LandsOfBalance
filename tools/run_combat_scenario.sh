...
case "$SCENARIO" in
    A|B|GRASS|PROMO|LOCKON|DODGE|PARRY|BACKSTAB|ESTUS|SOULS|MOVE|COMBO|PLAY|ARROW|ARCHER|RIVER|DRAGON|COOP|SKEL|POSTER|BOWSIM|REVIVE|MOBSIM|PALSIM|BLOCKSIM|ANIMSIM|GEARSIM|DARKSIM) ;;
    *) echo "Scenario must be A, B, GRASS, PROMO, LOCKON, DODGE, PARRY, BACKSTAB, ESTUS, SOULS, MOVE, COMBO, PLAY, ARROW, ARCHER, RIVER, DRAGON, COOP, SKEL, POSTER, BOWSIM, REVIVE, MOBSIM, PALSIM, BLOCKSIM, ANIMSIM, GEARSIM, or DARKSIM (got: $SCENARIO)"; exit 1 ;;
esac
