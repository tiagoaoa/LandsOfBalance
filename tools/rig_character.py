...
# --- transfer the shipped weights onto the new body ------------------------
mod = new.modifiers.new("weights", 'DATA_TRANSFER')
mod.object = donor
mod.use_vert_data = True
mod.data_types_verts = {'VGROUP_WEIGHTS'}
mod.vert_mapping = 'POLYINTERP_NEAREST'
with bpy.context.temp_override(active_object=new, object=new,
                               selected_editable_objects=[new]):
